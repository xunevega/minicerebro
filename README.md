...
- Revision editorial en `POST /revision` y `POST /profiles/{profile_id}/revision`: aplica la ruta diagnostico-estructura-parrafo-frase-tono-limpieza sobre un texto concreto sin generar conocimiento, sin mutar perfil y sin guardar el texto crudo en auditoria.
