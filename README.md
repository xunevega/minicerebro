...
- `knowledge-v14` es la version publicada actual; acumula `knowledge-v8` (Gramatica Practica, Parte 2), `knowledge-v9` (Ortografia y Puntuacion), `knowledge-v10` (Estilo Editorial), `knowledge-v11` (Redaccion aplicada), `knowledge-v12` (Ortotipografia aplicada), `knowledge-v13` (Comentario de texto) y `knowledge-v14` (Retorica y argumentacion).
