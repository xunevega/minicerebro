...
- Publicacion V1 en `/knowledge/publication`, `/knowledge/publication/readiness`, `POST /knowledge/candidates` y `POST /knowledge/publications`: publicar significa convertir una `knowledge_version` candidata completa en conocimiento estable recuperable; no hay publicaciones parciales y una version publicada solo puede deprecarse o archivarse mediante una version posterior.
