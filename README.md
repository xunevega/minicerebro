...
- Ingestion V1 en `/knowledge/ingestion`, `/knowledge/ingestion/batches` y `/knowledge/ingestion/readiness`: una fuente registrada se transforma por lote fuente-edicion en propuestas trazables; nunca publica directamente y se bloquea si falta edicion, localizador, derechos o integridad.
