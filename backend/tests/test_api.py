...
def test_knowledge_cards_and_statistics_are_exposed():
    ...
    assert status.json()["version"] == "knowledge-v15"
...
def test_knowledge_query_interpretation_builds_restrictions_context_and_audit():
    ...
    assert payload["resolved_version"] == "knowledge-v15"
    assert payload["query_type"] == ["writing_recommendation"]
    assert "LENGUA" in payload["domain"]
    ...
    assert payload["retrieval_request"]["version"] == "knowledge-v15"
...
def test_knowledge_query_resolves_latest_to_published_v15():
    ...
    assert latest_payload["requested_version"] == "latest"
    assert latest_payload["resolved_version"] == "knowledge-v15"
    assert latest_payload["version"] == "knowledge-v15"
    ...
    assert orthography_payload["resolved_version"] == "knowledge-v15"
    ...
    assert terminology_payload["resolved_version"] == "knowledge-v15"
    ...
    assert lexicon_payload["resolved_version"] == "knowledge-v15"
    ...
    assert usage_payload["resolved_version"] == "knowledge-v15"
    ...
    assert grammar_payload["resolved_version"] == "knowledge-v15"
    ...
    assert grammar_part_2_payload["resolved_version"] == "knowledge-v15"
    ...
    assert punctuation_payload["resolved_version"] == "knowledge-v15"
    ...
    assert style_payload["resolved_version"] == "knowledge-v15"
    ...
    assert writing_practice_payload["resolved_version"] == "knowledge-v15"
    ...
    assert orthotypography_payload["resolved_version"] == "knowledge-v15"
    ...
    assert literary_commentary_payload["resolved_version"] == "knowledge-v15"
    ...
    assert rhetoric_payload["resolved_version"] == "knowledge-v15"
    ...
    assert quintilian_payload["resolved_version"] == "knowledge-v15"
