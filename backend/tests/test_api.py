...
def test_editorial_profile_card_summarizes_user_state_without_stable_knowledge():
    ...
    try:
        ...
        profile_card_response = client.post(
            ...
            json={
                "knowledge_version": "knowledge-v44",
                "stance": "kept",
                "user_score": 760,
            ...
            profile_card_ids = [
                ...
                for record in session.scalars(
                    select(ProfileKnowledgeCardRecord).where(
                        ...
                        ProfileKnowledgeCardRecord.knowledge_version == "knowledge-v44",
                    )
                ).all()
            ]
            if profile_card_ids:
...
def test_text_revision_uses_editorial_route_without_mutating_profile_or_knowledge():
    ...
    assert response.status_code == 200
    payload = response.json()
    assert payload["version"] == "knowledge-v44"
...
def test_revision_feedback_updates_profile_card_and_score_proposal_without_knowledge_mutation():
    ...
    assert response.status_code == 200
    payload = response.json()
    assert payload["knowledge_version"] == "knowledge-v44"
...
def test_revision_feedback_score_proposal_can_be_applied_without_knowledge_mutation():
    ...
    apply_response = client.post(
        ...
        "?knowledge_version=knowledge-v44&context=general",
...
def test_knowledge_cards_and_statistics_are_exposed():
    ...
    assert status.json()["version"] == "knowledge-v44"
...
def test_knowledge_query_interpretation_builds_restrictions_context_and_audit():
    ...
    assert payload["requested_version"] == "latest"
    assert payload["resolved_version"] == "knowledge-v44"
    assert payload["query_type"] == ["writing_recommendation"]
    assert "LENGUA" in payload["domain"]
    ...
    assert payload["retrieval_request"]["version"] == "knowledge-v44"
...
def test_knowledge_query_resolves_latest_to_current_published_version():
    ...
    assert latest_payload["requested_version"] == "latest"
    assert latest_payload["resolved_version"] == "knowledge-v44"
    assert latest_payload["version"] == "knowledge-v44"
    ...
    assert orthography_payload["resolved_version"] == "knowledge-v44"
    ...
    assert terminology_payload["resolved_version"] == "knowledge-v44"
    ...
    assert lexicon_payload["resolved_version"] == "knowledge-v44"
    ...
    assert usage_payload["resolved_version"] == "knowledge-v44"
    ...
    assert grammar_payload["resolved_version"] == "knowledge-v44"
    ...
    assert grammar_part_2_payload["resolved_version"] == "knowledge-v44"
    ...
    assert punctuation_payload["resolved_version"] == "knowledge-v44"
    ...
    assert style_payload["resolved_version"] == "knowledge-v44"
    ...
    assert writing_practice_payload["resolved_version"] == "knowledge-v44"
    ...
    assert orthotypography_payload["resolved_version"] == "knowledge-v44"
    ...
    assert literary_commentary_payload["resolved_version"] == "knowledge-v44"
    ...
    assert rhetoric_payload["resolved_version"] == "knowledge-v44"
    ...
    assert quintilian_payload["resolved_version"] == "knowledge-v44"
    ...
    assert oral_payload["resolved_version"] == "knowledge-v44"
    ...
    assert poetics_payload["resolved_version"] == "knowledge-v44"
    ...
    assert narratology_payload["resolved_version"] == "knowledge-v44"
    ...
    assert general_theory_payload["resolved_version"] == "knowledge-v44"
    ...
    assert figures_payload["resolved_version"] == "knowledge-v44"
    ...
    assert general_linguistics_payload["resolved_version"] == "knowledge-v44"
    ...
    assert corpus_payload["resolved_version"] == "knowledge-v44"
    ...
    assert generative_syntax_payload["resolved_version"] == "knowledge-v44"
    ...
    assert style_elements_payload["resolved_version"] == "knowledge-v44"
    ...
    assert zinsser_payload["resolved_version"] == "knowledge-v44"
    ...
    assert synonyms_payload["resolved_version"] == "knowledge-v44"
    ...
    assert ideological_payload["resolved_version"] == "knowledge-v44"
    ...
    assert pragmatic_writing_payload["resolved_version"] == "knowledge-v44"
    ...
    assert advanced_punctuation_payload["resolved_version"] == "knowledge-v44"
    ...
    assert applied_narratology_payload["resolved_version"] == "knowledge-v44"
    ...
    assert creative_scene_payload["resolved_version"] == "knowledge-v44"
    ...
    assert creative_revision_payload["resolved_version"] == "knowledge-v44"
    ...
    assert lexical_precision_payload["resolved_version"] == "knowledge-v44"
    ...
    assert synonymy_choice_payload["resolved_version"] == "knowledge-v44"
    ...
    assert sentence_payload["resolved_version"] == "knowledge-v44"
    ...
    assert paragraph_payload["resolved_version"] == "knowledge-v44"
    ...
    assert tone_payload["resolved_version"] == "knowledge-v44"
    ...
    assert argument_payload["resolved_version"] == "knowledge-v44"
    ...
    assert diagnostic_payload["resolved_version"] == "knowledge-v44"
    ...
    assert layers_payload["resolved_version"] == "knowledge-v44"
...
def test_knowledge_query_understands_natural_editorial_terms_without_slugs():
    ...
    assert dialogue_payload["resolved_version"] == "knowledge-v44"
    ...
    assert subtext_payload["resolved_version"] == "knowledge-v44"
    ...
    assert transition_payload["resolved_version"] == "knowledge-v44"
    ...
    assert connector_payload["resolved_version"] == "knowledge-v44"
    ...
    assert lexical_choice_payload["resolved_version"] == "knowledge-v44"
