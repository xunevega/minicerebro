...
LATEST_PUBLISHED_KNOWLEDGE_VERSION = "knowledge-v36"
...
PUBLISHED_BATCH_CONTEXT_BY_VERSION = {
    ...
    LATEST_PUBLISHED_KNOWLEDGE_VERSION: "seed_paragraph_progression_batch",
}
PUBLISHED_BATCH_TIMESTAMP_BY_VERSION = {
    ...
    LATEST_PUBLISHED_KNOWLEDGE_VERSION: KNOWLEDGE_V36_PUBLISHED_AT,
}
...
def seed_extraction_runs() -> list[KnowledgeExtractionRun]:
    ...
    return [
        ...
        *_published_batch_extraction_runs(V36_SEED_ITEMS, LATEST_PUBLISHED_KNOWLEDGE_VERSION),
    ]
...
def seed_proposals() -> list[KnowledgeProposal]:
    ...
    return [
        ...
        *_published_batch_proposals(V36_SEED_ITEMS, LATEST_PUBLISHED_KNOWLEDGE_VERSION),
    ]
...
def seed_nodes() -> list[KnowledgeNode]:
    return [
        ...
        *_published_batch_nodes(V36_SEED_ITEMS, LATEST_PUBLISHED_KNOWLEDGE_VERSION),
    ]
...
def seed_node_relations() -> list[KnowledgeNodeRelation]:
    return [
        ...
        *_published_batch_node_relations(V36_SEED_ITEMS, LATEST_PUBLISHED_KNOWLEDGE_VERSION),
    ]
...
def seed_evidence() -> list[KnowledgeEvidenceItem]:
    return [
        ...
        *_published_batch_evidence(V36_SEED_ITEMS, LATEST_PUBLISHED_KNOWLEDGE_VERSION),
    ]
...
def seed_claims() -> list[KnowledgeClaim]:
    return [
        ...
        *_published_batch_claims(V36_SEED_ITEMS, LATEST_PUBLISHED_KNOWLEDGE_VERSION),
    ]
...
def seed_cards() -> list[KnowledgeCard]:
    return [
        ...
        *_published_batch_cards(V36_SEED_ITEMS, LATEST_PUBLISHED_KNOWLEDGE_VERSION),
    ]
...
def seed_versions() -> list[KnowledgeVersion]:
    ...
    latest_chain = {*v35_chain, LATEST_PUBLISHED_KNOWLEDGE_VERSION}
    latest_sources = [
        source
        for source in seed_sources()
        if source.id in {*v35_source_ids, *{item["source_id"] for item in V36_SEED_ITEMS}}
    ]
    latest_node_ids = {*v35_node_ids, *{item["node_id"] for item in V36_SEED_ITEMS}}
