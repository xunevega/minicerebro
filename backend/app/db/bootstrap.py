...
def ensure_knowledge_seed_data(session: Session) -> None:
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v11") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v11",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v13") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v13",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v14") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v14",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v15") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v15",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v16") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v16",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v17") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v17",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v18") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v18",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v19") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v19",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v20") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v20",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v21") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v21",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v22") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v22",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v23") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v23",
                status="published",
                published_at="2026-07-23T22:00:00+00:00",
            )
        )
    if session.get(KnowledgeVersionRecord, "knowledge-v24") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v24",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v25") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v25",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v26") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v26",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v27") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v27",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v28") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v28",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v29") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v29",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v30") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v30",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v31") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v31",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v32") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v32",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v33") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v33",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v34") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v34",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v35") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v35",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v36") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v36",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v37") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v37",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v38") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v38",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v39") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v39",
                status="published",
                published_at="2026-07-26T13:00:00+00:00",
            )
        )
    if session.get(KnowledgeVersionRecord, "knowledge-v40") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v40",
                status="published",
                published_at="2026-07-26T14:00:00+00:00",
            )
        )
    if session.get(KnowledgeVersionRecord, "knowledge-v41") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v41",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v42") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v42",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v43") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v43",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v44") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v44",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v45") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v45",
                status="published",
    ...
    if session.get(KnowledgeVersionRecord, "knowledge-v46") is None:
        session.add(
            KnowledgeVersionRecord(
                id="knowledge-v46",
                status="published",
    ...
    _add_published_snapshot(
        ...
        timestamp="2026-07-23T19:00:00+00:00",
    )
    _add_published_snapshot(
        session,
        version_id="knowledge-v21",
        version_chain={
            "knowledge-v1",
            "knowledge-v2",
            "knowledge-v3",
    ...
    _add_published_snapshot(
        ...
        timestamp="2026-07-23T21:00:00+00:00",
    )
    _add_published_snapshot(
        session,
        version_id="knowledge-v23",
        version_chain={
            "knowledge-v1",
            "knowledge-v2",
            "knowledge-v3",
    ...
    _add_published_snapshot(
        ...
        timestamp="2026-07-23T23:00:00+00:00",
    )
    _add_published_snapshot(
        session,
        version_id="knowledge-v25",
        version_chain={
            "knowledge-v1",
            "knowledge-v2",
            "knowledge-v3",
