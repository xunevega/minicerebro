...
try {
  ...
  await selectedCard.getByText("Diccionario de la lengua espanola").waitFor();
  await selectedCard.getByText("catalogo F005; localizador pendiente de ingestion").waitFor();
