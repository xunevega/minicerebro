...
try {
  ...
  await libraryPanel.locator(".statusPill", { hasText: "235 fichas" }).waitFor({ timeout: 90000 });
  ...
  await gymPanel.locator(".metric", { hasText: "Fichas" }).filter({ hasText: "235" }).waitFor({
    timeout: 90000,
  });
  ...
  await versionPanel.locator(".versionItem", { hasText: "knowledge-v51" }).locator(".metric", { hasText: "Fuentes" }).filter({ hasText: "26" }).waitFor();
  await versionPanel.locator(".versionItem", { hasText: "knowledge-v51" }).getByText("0 fuentes").waitFor();
  await versionPanel.locator(".versionItem", { hasText: "knowledge-v51" }).getByText("+4 nodos").waitFor();
  ...
  await explorationPanel.locator(".metric", { hasText: "Nodos" }).filter({ hasText: "237" }).waitFor();
  await explorationPanel.locator(".metric", { hasText: "Evidencias" }).filter({ hasText: "235" }).waitFor();
  ...
  await queryPanel.locator(".metric", { hasText: "Base recuperada" }).filter({ hasText: "knowledge-v51" }).waitFor();
