...
try {
  ...
  await libraryPanel.locator(".statusPill", { hasText: "157 fichas" }).waitFor({ timeout: 90000 });
  ...
  await gymPanel.locator(".metric", { hasText: "Fichas" }).filter({ hasText: "157" }).waitFor({
    timeout: 90000,
  });
  ...
  await versionPanel.locator(".versionItem", { hasText: "knowledge-v34" }).locator(".metric", { hasText: "Fuentes" }).filter({ hasText: "26" }).waitFor();
  await versionPanel.locator(".versionItem", { hasText: "knowledge-v34" }).getByText("0 fuentes").waitFor();
  await versionPanel.locator(".versionItem", { hasText: "knowledge-v34" }).getByText("+5 nodos").waitFor();
  ...
  await explorationPanel.locator(".metric", { hasText: "Nodos" }).filter({ hasText: "159" }).waitFor();
  await explorationPanel.locator(".metric", { hasText: "Evidencias" }).filter({ hasText: "157" }).waitFor();
  ...
  await queryPanel.locator(".metric", { hasText: "Base recuperada" }).filter({ hasText: "knowledge-v34" }).waitFor();
