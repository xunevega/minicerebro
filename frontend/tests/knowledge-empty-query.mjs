...
try {
  ...
  await libraryPanel.locator(".statusPill", { hasText: "167 fichas" }).waitFor({ timeout: 90000 });
  ...
  await gymPanel.locator(".metric", { hasText: "Fichas" }).filter({ hasText: "167" }).waitFor({
    timeout: 90000,
  });
  ...
  await versionPanel.locator(".versionItem", { hasText: "knowledge-v36" }).locator(".metric", { hasText: "Fuentes" }).filter({ hasText: "26" }).waitFor();
  await versionPanel.locator(".versionItem", { hasText: "knowledge-v36" }).getByText("0 fuentes").waitFor();
  await versionPanel.locator(".versionItem", { hasText: "knowledge-v36" }).getByText("+5 nodos").waitFor();
  ...
  await explorationPanel.locator(".metric", { hasText: "Nodos" }).filter({ hasText: "169" }).waitFor();
  await explorationPanel.locator(".metric", { hasText: "Evidencias" }).filter({ hasText: "167" }).waitFor();
  ...
  await queryPanel.locator(".metric", { hasText: "Base recuperada" }).filter({ hasText: "knowledge-v36" }).waitFor();
